...
const isImage = image =>
  ...
  const getBase64Image = (imageProps) => {
    ...
    let base64CachePath = '.cache/contentful/base64/';
    if(process.env.BASE64_CACHE_PATH){
      base64CachePath = process.env.BASE64_CACHE_PATH;
    }

    const CACHE_DIR = resolve(base64CachePath);
